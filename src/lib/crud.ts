 ...
 */
export function update<T>(obj: T, prop: string, mapFn: Function, val: any): T { return Object.assign({}, obj, {[prop]: mapFn(obj[prop], val)}) };
 ...
 * @returns {T} Same object with value of destination key updated using maping function.
 */
export function update_in<T>(obj: T, propMap: Array<string>, mapFn: Function, val: any): T {
    ...
    obj[propMap[0]] = update_in(obj[propMap[0]], propMap.slice(1, propMap.length), mapFn, val);
    return obj;
}
